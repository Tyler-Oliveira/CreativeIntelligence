...
# Names that should never appear in shipping content
PATTERNS=(
  'Peter Walters' 'Mischke' 'Nate Uyeda' 'Jonathan York' 'Kevin Losani'
  'Matt Monahan' 'Matthew Monahan' 'themattymo'
  'TMFA Creator System' '\bTMFA\b' 'Studio Matty Mo'
  '/Users/tmfa'
  'RECIPIENTS\.md' 'email-to-peter' 'COHORT_1_HANDOUT'
...
PRIVATE_FILES=(
  'RECIPIENTS.md' 'email-to-peter.md' 'COHORT_1_HANDOUT.md' 'COHORT_1_HANDOUT.pdf'
