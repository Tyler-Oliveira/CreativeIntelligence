...
THEME_TAGS = {
    ...
    r"art city|Anytown|sculpture park|glamping|your-highway.*your state|sample landmark.*sample venue": [
        "art-city", "Anytown", "your-state"
    ],
    # Monolith
