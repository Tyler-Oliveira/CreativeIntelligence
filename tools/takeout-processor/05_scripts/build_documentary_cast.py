...
ERA_NAMES = {
    ...
    'art_city': '6. Your Company / Anytown (2023-present)',
...
def process_cast(enriched_dirs, output_path):
    ...
    era_order = ['pre_brand', 'brand_launch', 'brand_commission', 'community_platform', 'nft_boom', 'art_city', 'unknown']
